    ...
    this.runs = [
      {
        ...
        commit: {
          ...
          shortHash: 'a1b2c3d',
          message: 'release: v4.5.0 Auto-Updater Subsystem, SHA-256 integrity verification, and release automation',
        },
        ...
        jobs: [
          {
            ...
            steps: [
              ...
              { number: 3, name: 'Build TypeScript & Vite bundle (4.5.0)', status: 'completed', conclusion: 'success', durationSeconds: 36 },
              { number: 4, name: 'Package Electron binary & NSIS installer', status: 'in_progress', conclusion: null, durationSeconds: 14 },
              { number: 5, name: 'Upload Release Asset (IndoctrinatedEdit-Setup-4.5.0.exe)', status: 'queued', conclusion: null, durationSeconds: 0 },
            ],
          },
          {
            id: 'job_linux_450',
            ...
            steps: [
              ...
              { number: 3, name: 'Compile Web & Main Processes (v4.5.0)', status: 'completed', conclusion: 'success', durationSeconds: 35 },
              { number: 4, name: 'Generate AppImage & Tarball binaries', status: 'in_progress', conclusion: null, durationSeconds: 12 },
              { number: 5, name: 'Upload release assets (IndoctrinatedEdit-4.5.0.AppImage)', status: 'queued', conclusion: null, durationSeconds: 0 },
            ],
          },
        ],
      },
